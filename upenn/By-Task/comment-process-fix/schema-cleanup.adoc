...
link:{curDir}/csv/commentstableid.txt[External References]
...
link:{curDir}/csv/commenttargetcategory.txt[External References]
...
link:{curDir}/csv/comment_target.txt[External References]
...
link:{curDir}/csv/comments.comment_target_id.txt[External References]
